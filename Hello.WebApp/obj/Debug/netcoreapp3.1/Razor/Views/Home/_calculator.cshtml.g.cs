#pragma checksum "C:\Users\asus_vienthonga\Downloads\OrderSystemPJ\Hello.WebApp\Views\Home\_calculator.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0cd68d4b8b7a994da1640eb9cf2fb5b54c0df69b"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0cd68d4b8b7a994da1640eb9cf2fb5b54c0df69b", @"/Views/Home/_calculator.cshtml")]
        ...
        <div style=""width: 150px;height: 100%;border: 1px solid #d1ffca;"">
            <div class=""p-1"" style=""width: 100%;height: 50px;border-bottom: 1px solid #d1ffca;"">
                ...
                <div onclick=""OrderFinish()"" class=""p-1"" style=""width: 100%;height: calc(100% - 50px);border-top: 1px solid #d1ffca;"">
                    <div class=""btn btn-success"" style=""width: 100%;height: 100%"">
                        <p style=""line-height: 100px"">Payment</p>
                    </div>
                </div>
           
        </div>
        <div style=""width: 220px;height: 100%;border: 1px solid #d1ffca;"">
            <div style=""width: 100%;height: 100%;bord");
    ...
    function OrderFinish() {
        $.ajax({
            ...
            success: function (data) {
                wi");
            WriteLiteral(@"ndow.location.href = ""/Order""
            }
        });
    }
</script>
...
<script type=""text/javascript"">
            ...
            WriteLiteral(@"	});
				...
				$(""#number_pr"").click(function(){
					...
					$(""#number_ck"").removeClass('changeType');
					$(""#number_pr"").a");
            WriteLiteral(@"ddClass('changeType');
				});
